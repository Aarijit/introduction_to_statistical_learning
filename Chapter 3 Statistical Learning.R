...
To calculate the residual error relative to the response we use the mean of the response and the RSE. The mean of mpg is 23.4459. The RSE of the lm.fit was 4.906 which indicates a percentage error of 20.9248%. The R2R2 of the lm.fit was about 0.6059, meaning 60.5948% of the variance in mpg is explained by horsepower.
iii.
...
plot of chunk unnamed-chunk-19 There are a few observations that greatly exceed (p+1)/n(p+1)/n (0.0076) on the leverage-statistic plot that suggest that the corresponding points have high leverage.
11.
...
t=β/SE(β)β=∑xiyi∑x2iSE(β)=∑(yi−xiβ)2(n−1)∑x2i−−−−−−−−√t=∑xiyi∑x2i(n−1)∑x2i∑(yi−xiβ)2−−−−−−−−−−−−√n−1−−−−−√∑xiyi∑x2i∑(yi−xiβ)2−−−−−−−−−−−−−−−√n−1−−−−−√∑xiyi∑x2i∑(y2i−2βxiyi+x2iβ2)−−−−−−−−−−−−−−−−−−−−−−−√n−1−−−−−√∑xiyi∑x2i∑y2i−∑x2iβ(2∑xiyi−β∑x2i)−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−√n−1−−−−−√∑xiyi∑x2i∑y2i−∑xiyi(2∑xiyi−∑xiyi)−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−√t=n−1−−−−−√∑xiyi∑x2i∑y2i−(∑xiyi)2−−−−−−−−−−−−−−−−−−√
t=β/SE(β)β=∑xiyi∑xi2SE(β)=∑(yi−xiβ)2(n−1)∑xi2t=∑xiyi∑xi2(n−1)∑xi2∑(yi−xiβ)2n−1∑xiyi∑xi2∑(yi−xiβ)2n−1∑xiyi∑xi2∑(yi2−2βxiyi+xi2β2)n−1∑xiyi∑xi2∑yi2−∑xi2β(2∑xiyi−β∑xi2)n−1∑xiyi∑xi2∑yi2−∑xiyi(2∑xiyi−∑xiyi)t=n−1∑xiyi∑xi2∑yi2−(∑xiyi)2
...
y is of length 100. β0β0 is -1, β1β1 is 0.5.
13d.
...
## F-statistic: 44.4 on 2 and 97 DF,  p-value: 2.04e-14

There is evidence that model fit has increased over the training data given the slight increase in R2R2 and RSERSE. Although, the p-value of the t-statistic suggests that there isn’t a relationship between y and x2x2.
13h.
...
plot of chunk unnamed-chunk-34 As expected, the error observed in R2R2 and RSERSE decreases considerably.
13i.
...
plot of chunk unnamed-chunk-35 As expected, the error observed in R2R2 and RSERSE increases considerably.
13j.
...
Y=2+2X1+0.3X2+ϵβ0=2,β1=2,β3=0.3
Y=2+2X1+0.3X2+ϵβ0=2,β1=2,β3=0.3
14b.
...
β0=2.0533,β1=1.6336,β3=0.5588
The regression coefficients are close to the true coefficients, although with high standard error. We can reject the null hypothesis for β1β1 because its p-value is below 5%. We cannot reject the null hypothesis for β2β2 because its p-value is much above the 5% typical cutoff, over 60%.
14d.
